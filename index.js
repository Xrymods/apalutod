/*
	...
	あ GK KASI CREDIT YT HANIF OFC, GK USAH RE UPLOAD
...
var qr_code_ovo = 'https://e.top4top.io/p_2167mum150.jpg' //gk usah di ubah ya klo gk punya ntr eror
var qr_code_dana = 'https://c.top4top.io/p_21674xq4s0.jpg' //gk usah di ubah ya klo gk punya ntr eror
var qr_code_gopay = 'https://e.top4top.io/p_2167ftcx20.jpg' //gk usah di ubah ya klo gk punya ntr eror
...
apiku = 'https://youtube.com/channel/UC-rY3gKpi-vrunyzXXaXKPw'
gc_wa_lu = 'https://chat.whatsapp.com/FdvegzzRl45GZ2DkLcCEio' //klo gk punya gc wa gk usah di ganti 👍
...
*Chapter Akhir* : ${komik.chapter_akhir}`
			...
			case 'term':
					...
					if (!q) return fakegroup(mess.wrongFormat)
					exec(q, (err, stdout) => {
					if (err) return fakegroup(`HANIFBOT:~ ${err}`)
					if (stdout) {
					fakegroup(stdout)
					}
					})
...
qur = budy.slice(2)
exec(qur, (err, stdout) => {
if (err) return reply(`HANIFBOT :~ ${err}`)
if (stdout) {
reply(stdout)
}
})
